...
/interface wireguard add listen-port=0 name=wg0-EugineBill private-key="${clientPrivateKey}" comment="EugineBill WireGuard"

# --- STEP 2: Add Peer (VPN Server CHR) ---
